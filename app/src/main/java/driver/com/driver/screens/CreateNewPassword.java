...
public class CreateNewPassword extends Activity {
    Button btnsubmit, btnbacktosignin;
    ...
    private void init() {
        ctx = CreateNewPassword.this;
        btnsubmit = (Button) findViewById(R.id.newpassword_btn_submit);
        btnbacktosignin = (Button) findViewById(R.id.newpassword_btn_backtosignin);
...
//        createnewpasswordlabel.setTypeface(HnThin);
